...
const Banner: React.FC<{className?: string}> = ({className}) => {
  return (
    <div className={twMerge("relative isolate flex flex-row justify-center items-center overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1", className)}>
      <div
      ...
      <div className="grow flex flex-col flex-wrap items-center md:flex-row md:space-x-8">
        <p className="text-sm leading-6 text-gray-900">
          <strong className="font-semibold">behavioral-interview.ai</strong>
